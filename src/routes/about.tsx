  ...
  head: () => ({
    meta: [
      { title: "About — Carthage Digi Books" },
      {
        name: "description",
        content:
          "About Carthage Digi Books and answers to frequently asked questions about our digital playbooks.",
      },
      { property: "og:title", content: "About — Carthage Digi Books" },
      {
        property: "og:description",
        content: "Who we are and answers to common questions.",
      },
    ],
  }),
  component: AboutPage,
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes — within 24 hours of purchase. See our refund policy for the details.",
  },
  {
